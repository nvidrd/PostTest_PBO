...
public class Main {
    ...
    static void main_menu() throws IOException{
        ...
        switch (menu){
            case 1 -> PostTest_3.CRUD.createData();
            case 2 -> {
                System.out.println("\n-----------------------------------------------");
                System.out.println("|          MENU TAMPIL DATA KARYAWAN          |");
                PostTest_3.CRUD.readData();
            }
            case 3 -> PostTest_3.CRUD.updateData();
            case 4 -> PostTest_3.CRUD.deleteData();
            case 5 -> PostTest_3.CRUD.exit();
